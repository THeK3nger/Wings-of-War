...
${OBJECTDIR}/CardSetLoader.o: CardSetLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CardSetLoader.o CardSetLoader.cpp
...
${OBJECTDIR}/Kicker.o: Kicker.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Kicker.o Kicker.cpp
...
${OBJECTDIR}/WoWBrain.o: WoWBrain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/WoWBrain.o WoWBrain.cpp
...
${OBJECTDIR}/CardSetLoader_nomain.o: ${OBJECTDIR}/CardSetLoader.o CardSetLoader.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/CardSetLoader_nomain.o CardSetLoader.cpp;\
	else  \
...
${OBJECTDIR}/Kicker_nomain.o: ${OBJECTDIR}/Kicker.o Kicker.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Kicker_nomain.o Kicker.cpp;\
	else  \
